...
const SetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token) {
      setError('Invalid or missing set password token');
      return;
    }
    ...
    try {
      const response = await setPassword(token, newPassword, confirmPassword);
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 transition duration-200"
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-400 text-white font-semibold py-2.5 px-4 rounded-lg transition duration-200 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
                  <svg
