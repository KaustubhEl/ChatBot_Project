...
import { registerOrganization, getCategories, getSubtypes, getSubtypeClasses, getPackages, registerOrgAdmin } from '../services/api';
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex justify-end">
                                <button
                                    ...
                                    className="py-3 px-8 bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-400 text-white font-bold rounded-lg transition duration-200"
                                >
                                    Next Step
                                </button>
                            </div>
